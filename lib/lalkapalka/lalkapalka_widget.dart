...
class LalkapalkaWidget extends StatefulWidget {
  LalkapalkaWidget({Key key}) : super(key: key);

  @override
  _LalkapalkaWidgetState createState() => _LalkapalkaWidgetState();
}

class _LalkapalkaWidgetState extends State<LalkapalkaWidget> {
